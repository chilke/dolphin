...
// clang-format off
constexpr std::array<const char*, 127> s_hotkey_labels{{
    _trans("Open"),
    _trans("Change Disc"),
    _trans("Eject Disc"),
    ...
    _trans("Save State"),
    _trans("Load State"),
    _trans("Increment State"),
    _trans("Decrement State"),
}};
// clang-format on
...
constexpr std::array<HotkeyGroupInfo, NUM_HOTKEY_GROUPS> s_groups_info = {
    {{_trans("General"), HK_OPEN, HK_REQUEST_GOLF_CONTROL},
     ...
     {_trans("Other State Hotkeys"), HK_SAVE_FIRST_STATE, HK_DEC_STATE_SLOT}}};
